...
&   "-g -O2  -I/usr/lib/x86_64-linux-gnu/netcdf/mpi/include -I/usr/lib/x86_64-linux-gnu/netcdf/mpi/include "
character(len=*),parameter :: cxx_flags  = &
&   " -O2      "
character(len=*),parameter :: fc_flags   = &
&   "-g3 -fbacktrace -fcheck=all,no-array-temps -Wall -ffree-line-length ..."
